...
#The main bug is this code is that the Unicode for the player dissappears and reappears sometimes
#after encountering another unocode
#I have to find the issue but the game is playable.
...
castle_descent = function(){
  ...
  castle[,,3][sample(which(castle[,,3]==""),1)] = "E"
  #Spawn stairs
  ...
  while(!(isTRUE(player_information$encountered_object=="E")==T||isTRUE(player_information$player_health<=0)==T)){
